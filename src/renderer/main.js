...
InviziCache.loadDbToMemory().then((val) => {
  ...
  NowFol.showPerformanceMarks = showPerformanceMarks

  NowFol.isDev = function () {
    return process.mainModule.filename.indexOf('app.asar') === -1
  }

  window.NowFol = NowFol

  window.nowFolApp = { // TODO move to Invizi object above
    stealthMode: InviziCache.getItem('Settings.stealthMode') || false
  }

  if (this) {
    this.nowFolApp = window.nowFolApp
  }
